...
This code is part of the CADL repo:
    https://github.com/pkmital/pycadl

Developed for the online course:
    "Creative Applications of Deep Learning" on Kadenze, Inc.

Course website:
    https://www.kadenze.com/programs/
...
def batch_generator_random_crop(X, Y, min_size=256, max_size=512,
                                n_images=100):
    """Summary
